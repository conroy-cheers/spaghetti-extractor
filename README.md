...
The active workflow is contract-first:
...
4. Acceptance is still decided by Stage A contract validation. Public
   candidate-only behavior tests are a final backstop after Stage A passes.
...
- `src/wincr/stage_a.py`: strict PE32 Stage A validation and reference contracts.
