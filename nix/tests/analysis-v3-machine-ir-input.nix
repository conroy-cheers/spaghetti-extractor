...
let
  binary = pkgs.writeText "analysis-v3-source-plan-fixture.exe" "MZfixture";
  ...
  mkInput = marker:
    import ../analysis-v3-machine-ir-input.nix {
      inherit pkgs pythonEnv pythonSource binary;
      name = "analysis-v3-machine-ir";
      binaryIdentity = "fixture.exe";
      machineIr = mkMachineIr "analysis-v3-machine-ir" marker;
    };
  base = mkInput "base-a";
...
pkgs.linkFarm "analysis-v3-machine-ir-input-check" [
  {
    name = "plan.json";
