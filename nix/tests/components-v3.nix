...
let
  ...
  fixture = pkgs.runCommand "spaghetti-extractor-components-v3-fixture"
    { nativeBuildInputs = [ pythonEnv ]; __contentAddressed = true; } ''
      ...
      PY
    '';
  mkDag = reviewRoot: sourceRoot: import ../stage-b-components-v3.nix {
    ...
    namePrefix = "spaghetti-extractor-components-v3-fixture";
  };
  base = mkDag ./fixtures/components-v3/base ./fixtures/components-v3/source-base;
  changed = mkDag ./fixtures/components-v3/changed ./fixtures/components-v3/source-base;
  sourceChanged = mkDag ./fixtures/components-v3/base ./fixtures/components-v3/source-changed;
  interpreter = pkgs.runCommand "spaghetti-extractor-components-v3-interpreter-fixture"
...
pkgs.linkFarm "spaghetti-extractor-components-v3-check" [
