...
let
  ...
  mkBundle = {
    ...
    in
      ...
      {
        _type = "spaghetti-extractor-target-definition-v1";
  ...
  validateRegistry = registry:
    assert lib.all
      (id:
        ...
        in bundle._type or null == "spaghetti-extractor-target-definition-v1"
          && bundle.metadata.id == id)
      (builtins.attrNames registry);
    registry;
in
{
  format = "spaghetti-extractor-target-sdk-v1";
