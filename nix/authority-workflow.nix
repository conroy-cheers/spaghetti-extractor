...
let
  ...
  externalInputs = import ./authority-input-external-inputs.nix {
    inherit
      pkgs
      pythonEnv
      pythonSource
  ...
  standardEvidence = import ./authority-input-standard-evidence.nix {
  ...
  generatedISAEvidence =
    ...
    then
      ...
      import ./authority-input-isa-evidence.nix {
        inherit
          pkgs
          pythonEnv
          pythonSource
  ...
  generatedIndexedTargetEvidence =
    ...
    then
      ...
      import ./authority-input-indexed-target-evidence.nix {
  ...
  generatedExternalSiteEvidence =
    ...
    then
      ...
      import ./authority-input-external-site-evidence.nix {
        inherit pkgs pythonEnv pythonSource contentAddressed;
  ...
  finalAuthorityGate =
    if finalAuthorityArtifact == null then
      ...
      import ./authority-final-gate.nix {
        inherit pkgs pythonEnv pythonSource contentAddressed;
  ...
  diagnostics = import ./authority-diagnostics.nix {
    inherit pkgs pythonEnv pythonSource contentAddressed;
