...
, originalFixture
, mingw32
, mkLeanGraph ? import ../../nix/stage-a-lean-graph.nix
...
let
  ...
  driver = ./nix/gnu-hello-roundtrip-driver.py;
  callableExternalRuntimeDriver = ../../nix/callable-external-runtime-contract.py;
  directCallSemanticsDriver = ./nix/gnu-hello-direct-call-semantics.py;
  directCallFixedPointDriver = ./nix/gnu-hello-direct-call-fixed-point.py;
  stackDynamicAuthorityDriver = ./nix/gnu-hello-stack-dynamic-authority.py;
  leanTermReceiptDriver = ../../nix/stage-a-lean-term-receipts.py;
  semanticCoverageDriver = ../../nix/stage-a-semantic-coverage.py;
  stackDynamicHints = ./nix/gnu-hello-stack-dynamic-hints.json;
  proofSourceAggregateDriver = ../../nix/stage-a-proof-source-aggregate.py;
  kernelDataDriver = ./nix/gnu-hello-kernel-data-driver.py;
  nativeSourceStaticAuthorityDriver =
    ./nix/gnu-hello-native-source-static-authority.py;
  compiledKernelDriver = ./nix/gnu-hello-compiled-kernel.py;
  proofClosureDriver = ./nix/gnu-hello-proof-closure-driver.py;
  constructiveSourceCoverageDriver =
    ./nix/gnu-hello-constructive-source-coverage.py;
  canonicalRelationCoreDriver = ./nix/gnu-hello-canonical-relation-core.py;
  acceptanceRequirementsDriver = ./nix/gnu-hello-acceptance-requirements.py;
  nativeLaunchGraphDriver = ./nix/gnu-hello-native-launch-graph.py;
  diagnosticDriver = ./nix/gnu-hello-roundtrip-diagnostic.py;
  accessFaultQualificationDriver = ./nix/gnu-hello-access-domain-receipts.py;
  universalPairedExternalEnvironmentDriver =
    ./nix/gnu-hello-universal-paired-external-environment.py;
  fixtureRoot =
  ...
  stageBPythonSources = import ../../nix/stage-b-python-sources.nix { inherit pkgs; };
  ...
  idiomaticHelloSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ./source/idiomatic/hello.c
      ./source/idiomatic/hello.h
    ];
  };
  ...
  acceptanceRequirementsPythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_acceptance_requirements.py
    ];
  };
  gnuHelloMixedAcceptancePythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      ../../src/spaghetti_extractor/relational/lean/interpreter_mixed_kernel_binding.py
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_acceptance_requirements.py
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_mixed_acceptance.py
      (lib.fileset.maybeMissing ./nix/gnu-hello-mixed-acceptance.py)
    ];
  };
  mixedChunkedAcceptancePythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      (lib.fileset.maybeMissing
        ../../nix/interpreter-mixed-chunked-acceptance.py)
    ];
  };
  gnuHelloStaticClosureCommonFiles = lib.fileset.unions [
    ...
    ../../src/spaghetti_extractor/relational/__init__.py
    ../../src/spaghetti_extractor/relational/lean/__init__.py
    (lib.fileset.maybeMissing ./nix/gnu-hello-static-closure-producers.py)
  ];
  ...
  runtimeFoundationPythonSource =
    mkGnuHelloStaticClosurePythonSource
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_runtime_foundation.py;
  launchBindingPythonSource = lib.fileset.toSource {
    root = ../..;
    fileset = lib.fileset.unions [
      gnuHelloStaticClosureCommonFiles
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_acceptance_requirements.py
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_launch_binding.py
      ../../src/spaghetti_extractor/relational/lean/interpreter_mixed_kernel_binding.py
    ];
  };
  externalComponentPythonSource =
    mkGnuHelloStaticClosurePythonSource
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_external_component.py;
  ...
  mixedFusedSemanticEvidencePythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_mixed_fused_semantic_evidence.py
      (lib.fileset.maybeMissing
        ./nix/gnu-hello-mixed-fused-semantic-evidence.py)
    ];
  };
  mixedDirectCallSemanticEvidencePythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      ../../src/spaghetti_extractor/relational/lean/interpreter_normalization.py
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_mixed_fused_semantic_evidence.py
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_mixed_direct_call_semantic_evidence.py
      (lib.fileset.maybeMissing
        ./nix/gnu-hello-mixed-direct-call-semantic-evidence.py)
    ];
  };
  mixedIndirectImportCallSemanticEvidencePythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      ../../src/spaghetti_extractor/relational/lean/interpreter_normalization.py
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_mixed_fused_semantic_evidence.py
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_mixed_indirect_import_call_semantic_evidence.py
      (lib.fileset.maybeMissing
        ./nix/gnu-hello-mixed-indirect-import-call-semantic-evidence.py)
    ];
  };
  mixedExternalTailSemanticEvidencePythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      ../../src/spaghetti_extractor/relational/lean/interpreter_normalization.py
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_mixed_fused_semantic_evidence.py
      ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_mixed_external_tail_semantic_evidence.py
      (lib.fileset.maybeMissing
        ./nix/gnu-hello-mixed-external-tail-semantic-evidence.py)
    ];
  };
  runtimeIndirectCompositionPythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      ../../src/spaghetti_extractor/relational/lean/__init__.py
      (lib.fileset.maybeMissing
        ./python/spaghetti_extractor_target_gnu_hello/gnu_hello_runtime_indirect_composition.py)
      (lib.fileset.maybeMissing
        ./nix/gnu-hello-runtime-indirect-composition.py)
    ];
  };
  operationInstantiationPythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      (lib.fileset.maybeMissing ./nix/gnu-hello-operation-instantiation.py)
    ];
  };
  runEntryRoutePythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      ../../src/spaghetti_extractor/relational/lean/__init__.py
      ../../src/spaghetti_extractor/relational/lean/interpreter_kernel_run_entry_route.py
      (lib.fileset.maybeMissing ./nix/gnu-hello-run-entry-route.py)
    ];
  };
  runEntryBehaviorsPythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      ../../src/spaghetti_extractor/relational/lean/interpreter_kernel_run_entry_route.py
      ../../src/spaghetti_extractor/relational/lean/interpreter_kernel_operation_behavior_materialization.py
      (lib.fileset.maybeMissing ./nix/gnu-hello-run-entry-behaviors.py)
    ];
  };
  runEntryAbiPythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      (lib.fileset.maybeMissing
        ../../src/spaghetti_extractor/relational/lean/interpreter_kernel_run_entry_projection.py)
      (lib.fileset.maybeMissing ./nix/gnu-hello-run-entry-abi.py)
    ];
  };
  programLookupNativeWorldBridgePythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      (lib.fileset.maybeMissing
        ./nix/gnu-hello-program-lookup-native-world-bridge.py)
    ];
  };
  interpreterStepWorldProgramLookupPythonSource = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      (lib.fileset.maybeMissing
        ./nix/gnu-hello-interpreter-step-world-program-lookup.py)
    ];
  };
  interpreterStepProgramLookupCallBehaviorsPythonSource =
    lib.fileset.toSource {
      ...
      fileset = lib.fileset.unions [
        ...
        (lib.fileset.maybeMissing
          ./nix/gnu-hello-step-program-lookup-call-behaviors.py)
      ];
    };
  ...
  staticClosureDriver =
    "${runtimeFoundationPythonSource}/targets/gnu-hello/nix/gnu-hello-static-closure-producers.py";
  launchBindingDriver =
    "${launchBindingPythonSource}/targets/gnu-hello/nix/gnu-hello-static-closure-producers.py";
  externalComponentDriver =
    "${externalComponentPythonSource}/targets/gnu-hello/nix/gnu-hello-static-closure-producers.py";
  runtimeIndirectCompositionDriver =
    "${runtimeIndirectCompositionPythonSource}/targets/gnu-hello/nix/gnu-hello-runtime-indirect-composition.py";
  operationInstantiationDriver =
    "${operationInstantiationPythonSource}/targets/gnu-hello/nix/gnu-hello-operation-instantiation.py";
  runEntryRouteDriver =
    "${runEntryRoutePythonSource}/targets/gnu-hello/nix/gnu-hello-run-entry-route.py";
  runEntryBehaviorsDriver =
    "${runEntryBehaviorsPythonSource}/targets/gnu-hello/nix/gnu-hello-run-entry-behaviors.py";
  runEntryAbiDriver =
    "${runEntryAbiPythonSource}/targets/gnu-hello/nix/gnu-hello-run-entry-abi.py";
  ...
  commonEnvironment = pythonSource: ''
    export PYTHONPATH=${pythonSource}/src:${pythonSource}/targets/gnu-hello/python
  ...
  opaqueStaticExport = pkgs.runCommand
    ...
    ''
      ...
      jq -e '
        ...
        .counts.regions == 7742 and
        .counts.transfers == 7742 and
  ...
  opaqueStateMachine = pkgs.runCommand
    ...
    ''
      ...
      jq -e '
        ...
        .status == "complete" and
        .counts.input_transfers == 7742 and
        .counts.padding_bridges == 120 and
        .counts.output_transfers == 7862 and
  ...
  machineIr = pkgs.runCommand
    ...
    ''
      ...
      jq -e '
        ...
        .control.counts.closed_indirect_exits == 4 and
  ...
  reconstructionInterpreter = pkgs.runCommand
    ...
    ''
      ...
      jq -e '
        ...
        .status == "ready" and
        .counts.input_transfers == 7862 and
        .counts.transfers == 7862 and
  ...
  reconstructionWorkspaceDag = import ../../nix/stage-b-reconstruction-workspace.nix {
    ...
    clusters = [
      ...
      }
      {
        ...
        expectedCases = 13;
        portableSource = ./source/components/atomic.c;
      }
      {
        name = "callback";
        entryRva = 4407;
      ...
      }
      {
        ...
        template = "manual_contract";
        expectedCases = 36;
        portableSource = ./source/components/dispatch.c;
      }
      {
        name = "typed-memory";
        entryRva = 53481;
        template = "manual_contract";
        expectedCases = 101;
        portableSource = ./source/components/typed-memory.c;
      }
    ];
  };
  reconstructionPlan = reconstructionWorkspaceDag.plan;
  # The selected catalog is the target's only component authority. The former
  # checked-in validation catalog mixed generated machine bindings with review
  # data and could silently become stale.
  semanticComponents = selectedSemanticComponents;
  componentProposals = import ../../nix/stage-b-component-discovery.nix {
    inherit pkgs pythonEnv;
  ...
  targetIntent = import ../../nix/stage-b-target-intent.nix {
    inherit pkgs pythonEnv componentProposals;
    pythonSource = sourceRoot;
    target = ./.;
  };
  selectedComponentDeclarations = import ../../nix/stage-b-component-selection.nix {
    inherit pkgs pythonEnv componentProposals;
    pythonSource = componentSelectionPythonSource;
    selection = "${targetIntent.componentSelection}/component-selection.json";
    namePrefix = "stage-b-gnu-hello";
  };
  selectedSemanticComponents = import ../../nix/stage-b-semantic-components.nix {
    inherit pkgs pythonEnv;
  ...
  semanticComponentWorkspaceDag = import ../../nix/stage-b-semantic-component-workspaces.nix {
    inherit pkgs pythonEnv;
  ...
  let
    nativeObjectDag = import ../../nix/stage-b-native-object-graph.nix {
      inherit pkgs pythonEnv;
  ...
  sourceOriginalAuthorityPipeline = import ./default.nix {
    inherit
      pkgs
      pythonEnv
      spaghettiExtractor
  ...
  sourceCompiledAuthorityInputs = mkPhase
    ...
    ${python} -m \
      spaghetti_extractor_target_gnu_hello.gnu_hello_native_source_compiled_authority_inputs \
      --source-bundle ${sourceBundle}/native-source-bundle.json \
  ...
  sourceCompiledAuthorityProducedEvidence = mkPhase
    ...
    [ pkgs.nix ] ''
    ${python} -m \
      spaghetti_extractor_target_gnu_hello.gnu_hello_native_source_compiled_authority_evidence \
      --source-bundle ${sourceBundle}/native-source-bundle.json \
      --compilation-attestation \
        ${sourceCompilationAttestation}/native-source-compilation-attestation.json \
  ...
  sourceEnvironmentFamilyEvidence =
    if nativeSourceEnvironmentFamilyEvidence != null then
      ...
      mkMissingNativeSourceEvidence {
        ...
        contract =
          "stage-a-native-source-acceptance-declarations-v1; nonempty admitted pairs, exact external evidence, pair-indexed launch evidence, and sole approved toolchain axiom ${nativeSourceApprovedToolchainAxiom}";
      };
  ...
  sourceRuntimeFunctionalSuiteData = import ./nix/gnu-hello-native-source-runtime-suite.nix {
  ...
  idiomaticSourceBinding = pkgs.runCommand
    ...
    ''
      ...
      ${python} - \
        ${machineIr} \
        ${builtins.elemAt targetIntent.sourceProjects 0}/source-project.json \
  ...
  idiomaticCandidate = pkgs.runCommand
    ...
    ''
      ...
      cp ${builtins.elemAt targetIntent.sourceProjects 0}/source-project.json \
  ...
  idiomaticUpstreamSuiteDag = import ../../nix/stage-b-upstream-shell-suite.nix {
    inherit pkgs;
  ...
  sideIsaCorpus = mkAnalysisPhase
    ...
    ' "$out/result.json" >/dev/null
  '';
  sideIsaQualification = import ../../nix/stage-a-isa-qualification-graph.nix {
  ...
  mixedOriginalDirectCallProposalsLean = mkPhaseWithSource
    ...
    ${python} ${driver} mixed-original-direct-call-proposals \
      ...
      --runtime-value-carry-hints \
        ${./nix/gnu-hello-stack-dynamic-hints.json} \
      --shard-size 128 \
      --out "$out"
    jq -e '
  ...
  mixedFusedSemanticEvidenceLean =
    mkPhaseWithSource mixedFusedSemanticEvidencePythonSource
      ...
      ${python} \
        ${mixedFusedSemanticEvidencePythonSource}/targets/gnu-hello/nix/gnu-hello-mixed-fused-semantic-evidence.py \
        --state-machine ${proofStateMachinePath} \
        --out "$out"
      jq -e '
        .format ==
  ...
  mixedDirectCallSemanticEvidenceLean =
    mkPhaseWithSource mixedDirectCallSemanticEvidencePythonSource
      ...
      ${python} \
        ${mixedDirectCallSemanticEvidencePythonSource}/targets/gnu-hello/nix/gnu-hello-mixed-direct-call-semantic-evidence.py \
        --state-machine ${proofStateMachinePath} \
        --out "$out"
      jq -e '
        .format ==
  ...
  mixedIndirectImportCallSemanticEvidenceLean =
    mkPhaseWithSource mixedIndirectImportCallSemanticEvidencePythonSource
      ...
      ${python} \
        ${mixedIndirectImportCallSemanticEvidencePythonSource}/targets/gnu-hello/nix/gnu-hello-mixed-indirect-import-call-semantic-evidence.py \
        --state-machine ${proofStateMachinePath} \
        --out "$out"
      jq -e '
        .format ==
  ...
  mixedExternalTailSemanticEvidenceLean =
    mkPhaseWithSource mixedExternalTailSemanticEvidencePythonSource
      ...
      ${python} \
        ${mixedExternalTailSemanticEvidencePythonSource}/targets/gnu-hello/nix/gnu-hello-mixed-external-tail-semantic-evidence.py \
        --state-machine ${proofStateMachinePath} \
        --out "$out"
      jq -e '
        .format ==
  ...
  programLookupNativeWorldBridgeLean =
    mkPhaseWithSource programLookupNativeWorldBridgePythonSource
      ...
      ${python} \
        ${programLookupNativeWorldBridgePythonSource}/targets/gnu-hello/nix/gnu-hello-program-lookup-native-world-bridge.py \
        --candidate ${candidate}/candidate.exe \
        --lookup-native-plan \
          ${kernelLookupNativeLean}/interpreter-kernel-lookup-native-plan.json \
        --lookup-operation-plan \
  ...
  interpreterStepWorldProgramLookupLean =
    mkPhaseWithSource interpreterStepWorldProgramLookupPythonSource
      ...
      ${python} \
        ${interpreterStepWorldProgramLookupPythonSource}/targets/gnu-hello/nix/gnu-hello-interpreter-step-world-program-lookup.py \
        --candidate ${candidate}/candidate.exe \
  ...
  interpreterStepProgramLookupCallBehaviorsLean =
    mkPhaseWithSource
      ...
      [] ''
        ${python} \
          ${interpreterStepProgramLookupCallBehaviorsPythonSource}/targets/gnu-hello/nix/gnu-hello-step-program-lookup-call-behaviors.py \
          --candidate ${candidate}/candidate.exe \
          --program-lookup-native-world-bridge-plan \
            ${programLookupNativeWorldBridgeLean}/interpreter-kernel-program-lookup-native-world-bridge.json \
          --step-operation-plan \
  ...
  gnuHelloMixedAcceptanceLean =
    mkPhaseWithSource gnuHelloMixedAcceptancePythonSource
      ...
      ${python} \
        ${gnuHelloMixedAcceptancePythonSource}/targets/gnu-hello/nix/gnu-hello-mixed-acceptance.py \
        --out "$out"
      jq -e '
...
{
  targetIntentValidation = targetIntent.validation;
  targetComponentSelection = targetIntent.componentSelection;
  inherit
    smoke
