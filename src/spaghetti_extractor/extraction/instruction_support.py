"""Fast, untrusted capability checks before semantic qualification."""
...
def instruction_supported(insn: Any) -> bool:
    ...
    This check is diagnostic only. The qualified ISA model still checks exact
    encodings before a candidate can be qualified.
    """
