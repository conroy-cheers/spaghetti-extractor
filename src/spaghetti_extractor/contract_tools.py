"""Static mapping, reference-contract, and candidate-feedback tooling.

These operations propose or serialize evidence. Only relational v3 Lean acceptance
can establish whole-program equivalence.
"""
