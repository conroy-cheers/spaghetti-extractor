...
def write_binary_isa_inventory(
    *,
    binary: Path,
    inventory: Path,
    out: Path,
    ...
    """Classify selected executable spans with the compact Lean decoder."""

    from .binary_inventory import side_extraction_request_from_inventory
    from .isa_requirements import extract_lean_instruction_forms_side
    ...
    payload = side_isa_payload(
        request,
        forms=forms,
        classifier_sha256=str(evidence["classifier_sha256"]),
        extractor_sha256=str(evidence["extractor_sha256"]),
