...
def _related_machine_input_choice(
    ...
    *,
    ...
    The proposal remains untrusted metadata.  Lean acceptance binds the slot to
    the exact decoded transfer and proves that both executions read the related
    pre-instruction destination register.  Any other behavior-relevant
    undefined value remains an explicit frontier.
    """
