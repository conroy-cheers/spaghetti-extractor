...
class StageARelationalInterpreterKernelStepProgramLookupCallClosureKernelTests(
    unittest.TestCase
):
    def test_exact_computation_closure_compiles_without_unapproved_axioms(
        self,
    ) -> None:
        ...
        for theorem in (
            "ExactComputedInterpreterStepPath.toNativePath",
            "ConcreteProgramLookupNestedRequestFacts.toRequestRelated",
            "ExactComputedInterpreterStepProgramLookupReturn.toReturnPath",
            (
