...
class StageARelationalInterpreterKernelRunOperationResultBridgeKernelTests(
    unittest.TestCase
):
    def test_result_indexed_run_bridge_compiles_without_bad_axioms(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            _copy_module_closure(
                source_root,
                stage_a,
                "RelationalInterpreterKernelRunOperationResultBridge",
            )
            result = _run_lean_relational(
                root,
                bundle="RelationalInterpreterKernelRunOperationResultBridge",
            )
