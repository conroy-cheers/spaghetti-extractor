...
class StageARelationalInterpreterKernelStepWorldActionSimulationKernelTests(
    unittest.TestCase
):
    def test_world_action_simulation_compiles_without_unapproved_axioms(
        self,
    ) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            module = "RelationalInterpreterKernelStepWorldActionSimulation"
            ...
            for required in (
                ...
                "CheckedInterpreterNativeActionExecution",
                "toExactClosure",
                "toAuthority",
            ):
