...
class StageARelationalInterpreterKernelCDeclEpilogueMixedEnvironmentAdapterKernelTests(
    unittest.TestCase
):
    def test_adapter_compiles_without_bad_axioms(self) -> None:
        ...
        for theorem in (
            "MixedCDeclExternalReturnResidual.externalBoundary",
            "checkedMixedCDeclKernelExternalResponse",
            "CheckedMixedCDeclKernelExternalResponse.oneToOneTrace",
            "CheckedMixedCDeclKernelExternalResponse.invokeExternalTrace",
            "CheckedMixedCDeclKernelExternalResponse.interpreterStepSomeTrace",
        ):
