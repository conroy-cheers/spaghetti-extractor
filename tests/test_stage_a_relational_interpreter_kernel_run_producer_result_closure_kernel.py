...
class StageARelationalInterpreterKernelRunProducerResultClosureKernelTests(
    unittest.TestCase
):
    def test_exact_run_producer_closure_compiles_without_bad_axioms(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            _copy_module_closure(
                source_root,
                stage_a,
                "RelationalInterpreterKernelRunProducerResultClosure",
            )
            result = _run_lean_relational(
                root,
                bundle="RelationalInterpreterKernelRunProducerResultClosure",
            )
