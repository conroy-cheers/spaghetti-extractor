...
class StageARelationalInterpreterKernelStepActionSimulationKernelTests(
    unittest.TestCase
):
    def test_action_list_simulation_compiles_without_unapproved_axioms(
        self,
    ) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            module = "RelationalInterpreterKernelStepActionSimulation"
            ...
            for required in (
                "CheckedInterpreterActionDerivation",
                "CheckedInterpreterBodyDerivation",
                "ExactComputedInterpreterStepPath",
                "InterpreterStepNativeBodySimulationAuthority",
                "simulate",
                "toExactActionExecution",
            ):
        ...
        for theorem in (
            "InterpreterStepNativeBodySimulationAuthority.simulate",
            "CheckedInterpreterNativeBodyExecution.nativePath",
