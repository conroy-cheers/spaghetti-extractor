...
_MODULE = "RelationalInterpreterMixedOriginalSemanticReplay"
...
class StageARelationalInterpreterMixedOriginalSemanticReplayKernelTests(
    unittest.TestCase
):
    @unittest.skipUnless(shutil.which("lean"), "Lean is required")
    def test_bounded_original_semantic_replay_compiles_and_is_audited(
        self,
    ) -> None:
        source_root = (
        ...
        for declaration in (
            "ExactOriginalSemanticBefore.ofAtSource",
            "ExactOrdinaryOriginalSemanticSourceFacts.ofCarrier",
            "ExactOrdinaryOriginalSemanticSourceFacts.pe32BehaviorExact",
            "CheckedOriginalOrdinaryControlSuccessor.machineExact",
            "ExactOrdinaryOriginalSemanticStepFacts.stepMachineExact",
            "CheckedOrdinaryOriginalInterpreterStepReplay.ofExact",
            "checkedOrdinaryOriginalSemanticPath_path",
        ):
