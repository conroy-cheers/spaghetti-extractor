...
class StageARelationalInterpreterKernelInvokeResultClosureKernelTests(
    unittest.TestCase
):
    def test_exact_invoke_result_closure_compiles_without_bad_axioms(
        self,
    ) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            _copy_module_closure(
                source_root,
                stage_a,
                "RelationalInterpreterKernelInvokeResultClosure",
            )
            result = _run_lean_relational(
                root,
                bundle="RelationalInterpreterKernelInvokeResultClosure",
            )
        ...
        for theorem in (
            (
                "callResultEncodingResidual_iff_"
                "invokeResponseMachinePayloadHolds"
            ),
