...
class RelationalInterpreterKernelOperationNestedABIFrameKernelTests(
    unittest.TestCase
):
    def test_nested_abi_frame_kernel_checks(self) -> None:
        module = "RelationalInterpreterKernelOperationNestedABIFrame"
        ...
        self.assertIn(
            "KernelOperationNestedEntryProjection.toEntryFacts", output
        )
        self.assertIn(
            "KernelOperationNestedEntryProjection.toRequestFacts", output
        )
