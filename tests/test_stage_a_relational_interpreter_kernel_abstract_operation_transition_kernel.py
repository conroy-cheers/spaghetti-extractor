...
class StageARelationalInterpreterKernelAbstractOperationTransitionKernelTests(
    unittest.TestCase
):
    def test_checked_transition_layer_compiles_without_bad_axioms(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            result = _run_lean_relational(
                root,
                bundle="RelationalInterpreterKernelAbstractOperationTransition",
            )
        ...
        for theorem in (
            ...
            "programLookupTransition",
            "interpreterStepTransition",
            "AbstractRunFunction.toKernelTransition",
            "invokeExternalTransition",
            "invokeInternalTransition",
            "invokeIndirectTransition",
            "ExactAbstractOperationResultClosure.transition",
            (
    ...
    def test_source_has_only_typed_semantic_residuals(self) -> None:
        source = (
            Path(__file__).parents[1]
            / "src/spaghetti_extractor/lean/StageA"
            / "RelationalInterpreterKernelAbstractOperationTransition.lean"
