...
class StageARelationalInterpreterKernelCDeclEpilogueStaticPreservationKernelTests(
    unittest.TestCase
):
    def test_static_preservation_compiles_without_bad_axioms(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            result = _run_lean_relational(
                root,
                bundle=("RelationalInterpreterKernelCdeclEpilogueStaticPreservation"),
            )
        ...
        for theorem in (
            ...
            "checkedCDeclWriteFootprint_avoidsLoadedImage",
            "memoryFrame_preservesLoadedSpan",
            "memoryFrame_preservesCandidateImage",
            "memoryFrame_preservesImageRead32",
            "memoryFrame_preservesOriginalProgramTable",
            "StaticallyPreservedCDeclEpilogueCertificate.toSymbolicallyClosed",
            "StaticallyPreservedCDeclEpilogueCertificate.toChecked",
            "StaticallyPreservedCDeclEpilogueCertificate.responseRelated",
            "StaticallyPreservedCDeclEpilogueCertificate.memoryFrame",
            "StaticallyPreservedCDeclEpilogueCertificate.path",
        ):
