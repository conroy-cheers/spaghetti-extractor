...
class StageARelationalInterpreterKernelRunResultClosureKernelTests(
    unittest.TestCase
):
    def test_exact_run_result_closure_compiles_without_bad_axioms(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            _copy_module_closure(
                source_root,
                stage_a,
                "RelationalInterpreterKernelRunResultClosure",
            )
            result = _run_lean_relational(
                root,
                bundle="RelationalInterpreterKernelRunResultClosure",
            )
