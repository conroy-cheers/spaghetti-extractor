...
_MODULE = (
    "RelationalInterpreterMixedIndirectImportCallSemanticEvidenceAdapter"
)
...
class StageAMixedIndirectImportCallSemanticEvidenceAdapterKernelTests(
    unittest.TestCase
):
    ...
    def test_adapter_compiles_with_only_approved_axioms(self) -> None:
        ...
        for declaration in (
            "semanticCallExternalTarget?",
            "checkedIndirectOrImportExecutionForSource",
    ...
    def test_source_rejects_submitted_execution_authority(self) -> None:
        ...
        for required in (
            "CheckedIndirectExitCertificate",
            "CheckedCallableIndirectExitCertificate",
            "MachineImportCallContract",
            "ExternalCallSiteContract",
            "ExactIndirectOrImportCallOperationalCompleteness",
            "CheckedOriginalSemanticOperationPathShape",
