...
class RelationalInterpreterKernelOperationMemoryRouteKernelTests(
    unittest.TestCase
):
    def test_operation_memory_route_kernel_checks(self) -> None:
        module = "RelationalInterpreterKernelOperationMemoryRoute"
        ...
        self.assertIn(
            "symbolicBehaviorWritesInside_of_writes_singleton", output
        )
        self.assertIn("addressRangeInSpan_containsWordBytes", output)
