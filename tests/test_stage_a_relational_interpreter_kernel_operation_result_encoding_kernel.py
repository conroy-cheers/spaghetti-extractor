...
class StageARelationalInterpreterKernelOperationResultEncodingKernelTests(
    unittest.TestCase
):
    def test_exact_endpoint_encoding_layer_compiles_without_bad_axioms(
        self,
    ) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            result = _run_lean_relational(
                root,
                bundle="RelationalInterpreterKernelOperationResultEncoding",
            )
        ...
        for theorem in (
            ...
            "CallResultEncodingResidual.toRunFunctionEvidence",
            ...
            (
                ...
                "constructsOperationResultEvidence"
            ),
            (
    ...
    def test_source_does_not_reuse_broad_response_authority(self) -> None:
        source = (
            Path(__file__).parents[1]
            / "src/spaghetti_extractor/lean/StageA"
            / "RelationalInterpreterKernelOperationResultEncoding.lean"
