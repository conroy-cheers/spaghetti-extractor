...
class RelationalInterpreterKernelOperationABIFrameKernelTests(
    unittest.TestCase
):
    def test_operation_abi_frame_kernel_checks(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            _copy_module_closure(
                source_root,
                stage_a,
                "RelationalInterpreterKernelOperationABIFrame",
            )
            result = _run_lean_relational(
                root,
                bundle="RelationalInterpreterKernelOperationABIFrame",
            )
